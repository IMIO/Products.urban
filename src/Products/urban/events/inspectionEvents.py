...
def setInspectionBoundLicence(licence, event):
    ...
    previous_bound_UID = list(annotations.get('urban.inspection_bound_licence', set([])))
    ...
    if previous_bound_UID:
        ...
        if previous_licence:
            ...
            values = previous_licence_annotations.get('urban.bound_inspections', set([]))
    ...
    if new_bound_UID:
        ...
        if new_licence:
            ...
            values = new_licence_annotations.get('urban.bound_inspections', set([]))
