...
default_values = {
    ...
    'foldermakers': [
        ...
        {'id': "spw-dgo1", 'title': u"SPW-DGO1", 'description': u'<p>Direction Générale opérationnelle<br />Département du réseau de Namur et du Luxembourg<br />District 131.12 - SPY<br />37, Route de Saussin<br />5190 Spy</p>'},
        {'id': "dgrne", 'title': u"DGRNE", 'description': u'<p>1, Rue xxx<br />xxxx Commune</p>'},
        {'id': "dnf", 'title': u"DNF", 'description': u'<p>39, Avenue Reine Astrid<br />5000 Namur</p>'},
        {'id': "stp", 'title': u"Service Technique Provincial", 'description': u'<p>1, Rue xxx<br />xxxx Commune</p>'},
        {'id': "pi", 'title': u"Prévention Incendie", 'description': u'<p>1, Rue xxx<br />xxxx Commune</p>'},
        {'id': "bec", 'title': u"Bureau d'études communal", 'description': u'<p>1, Rue xxx<br />xxxx Commune</p>'},
        {'id': "svp", 'title': u"Service Voyer Principal", 'description': u'<p>1, Rue xxx<br />xxxx Commune</p>'},
        {'id': "agriculture", 'title': u"Agriculture", 'description': u'<p>Direction Générale opérationnelle<br />Agriculture, Ressources naturelles et Environnement<br />Service extérieur de Wavre<br />4, Avenue Pasteur<br />1300 Wavre</p>'},
        {'id': "pn", 'title': u"Parc Naturel", 'description': u'<p>1, Rue xxx<br />xxxx Commune</p>'},
        {'id': "crmsf", 'title': u"Commission Royale des Monuments, Sites et Fouilles", 'description': u'<p>1, Rue xxx<br />xxxx Commune</p>'},
        {'id': "swde", 'title': u"SWDE", 'description': u'<p>14, Rue Joseph Saintraint<br />5000 Namur</p>'},
        {'id': "ccatm", 'title': u"CCATM", 'description': u'<p>1, Rue xxx<br />xxxx Commune</p>'},
        {'id': "inasep", 'title': u"INASEP", 'description': u'<p>1b, Rue des Viaux<br />5100 Naninne</p>'},
        {'id': "belgacom", 'title': u"Belgacom", 'description': u'<p>60, Rue Marie Henriette<br />5000 Namur</p>'},
        {'id': "spge", 'title': u"SPGE", 'description': u'<p>1, Rue xxx<br />xxxx Commune</p>'},
        {'id': "cibe", 'title': u"CIBE/Vivaqua", 'description': u'<p>70, Rue aux Laines<br />1000 Bruxelles</p>'},
        {'id': "sncb", 'title': u"SNCB", 'description': u'<p>1, Rue xxx<br />xxxx Commune</p>'},
        {'id': "infrabel", 'title': u"Infrabel", 'description': u'<p>Infrastructure ferroviaire<br />2/003, Place des Guillemins<br />4000 Liège</p>'},
        {'id': "voo", 'title': u"VOO", 'description': u'<p>1, Rue xxx<br />xxxx Commune</p>'},
    ],
