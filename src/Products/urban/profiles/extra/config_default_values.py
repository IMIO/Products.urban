...
default_values = {
    ...
    'Ticket': {
        'offense_articles': [
            ...
            {'id': "art1.6", 'title': u"créer un nouveau logement"},
            {'id': "art1.7", 'title': u"modifier la destination "},
            {'id': "art1.8", 'title': u"modifier surf. vente"},
            {'id': "art1.9", 'title': u"relief du sol"},
            {'id': "art1.10", 'title': u"boiser ou déboiser"},
            {'id': "art1.11", 'title': u"abattre a) arbres isolés à haute tige dans espaces verts"},
            {'id': "art1.11", 'title': u"abattre b) haies ou allées (R.IV.4-6)"},
            {'id': "art1.12", 'title': u"abattre arbre/haie remarquable"},
            {'id': "art1.13", 'title': u"défricher"},
            {'id': "art1.14", 'title': u"sapins de Noël"},
            {'id': "art1.15", 'title': u"a) dépôt véhicules, mitrailles..."},
            {'id': "art1.16", 'title': u"b) installations mobiles"},
            {'id': "art1.17", 'title': u"itravaux de restauration CoPat / liste de sauvegarde, classé ou assimilé"},
