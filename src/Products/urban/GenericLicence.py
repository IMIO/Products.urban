...
schema = Schema((
    ...
    DataGridField(
        ...
        widget=DataGridWidget(
            columns={'number' : Column("Number"), 'street' : SelectColumn("Street", UrbanVocabulary('streets', vocType=("Street", "Locality", ), id_to_use="UID", inUrbanConfig=False, allowedStates=['enabled'])),},
            label='Worklocations',
