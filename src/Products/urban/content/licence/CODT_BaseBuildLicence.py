...
setSchemataForInquiry(CODT_BaseBuildLicence_schema)
##/code-section after-schema


class CODT_BaseBuildLicence(BaseFolder, Inquiry, GenericLicence, BrowserDefaultMixin):
    """
    """
    ...
    def getApplicants(self):
        """
        """
        applicants = self.getCorporations() or super(CODT_BaseBuildLicence, self).getApplicants()
        return applicants
