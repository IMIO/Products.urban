...
CODT_UniqueLicence_schema.delField('SDC')
CODT_UniqueLicence_schema.delField('sdcDetails')
CODT_UniqueLicence_schema.delField('township_guide')
CODT_UniqueLicence_schema.delField('township_guide_details')
