...
class UrbanBase(object):
    ...
    def getApplicantsSignaletic(self, withaddress=False, linebyline=False, remove_comma=False, withtitle=True):
        """
        ...
        for applicant in applicants:
            ...
            signaletic += applicant.getSignaletic(withaddress=withaddress, linebyline=linebyline, remove_comma=False, withtitle=withtitle)
        return signaletic
