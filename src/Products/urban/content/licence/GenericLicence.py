...
optional_fields = [
    ...
    'SDC', 'sdcDetails', 'township_guide', 'township_guide_details', 'floodingLevel', 'floodingLevelDetails',
    'solicitRoadOpinionsTo', 'areParcelsVerified', 'locationFloodingLevel', 'licenceSubject', 'referenceDGATLP',
