...
def addUrbanConfigs(context):
    ...
    for urban_type in URBAN_TYPES:
        ...
        if urban_type in ['BuildLicence', 'ParcelOutLicence', ]:
            ...
            newFolder.invokeFactory("UrbanVocabularyTerm",id="agriculture",title=u"Agriculture", description=u'<p>1, Rue xxx<br />xxxx Commune</p>')
            ...
            newFolder.invokeFactory("UrbanVocabularyTerm",id="swde",title=u"SWDE", description=u'<p>1, Rue xxx<br />xxxx Commune</p>')
            newFolder.invokeFactory("UrbanVocabularyTerm",id="ccatm",title=u"CCATM", description=u'<p>1, Rue xxx<br />xxxx Commune</p>')
            newFolder.invokeFactory("UrbanVocabularyTerm",id="inasep",title=u"INASEP", description=u'<p>1, Rue xxx<br />xxxx Commune</p>')
            ...
            newFolder.invokeFactory("UrbanVocabularyTerm",id="cibe",title=u"CIBE/Vivaque", description=u'<p>1, Rue xxx<br />xxxx Commune</p>')
            newFolder.invokeFactory("UrbanVocabularyTerm",id="sncb",title=u"SNCB", description=u'<p>1, Rue xxx<br />xxxx Commune</p>')
            newFolder.invokeFactory("UrbanVocabularyTerm",id="infrabel",title=u"Infrabel", description=u'<p>1, Rue xxx<br />xxxx Commune</p>')
...
def addInvestigationArticles(context, configFolder):
    ...
    newFolder.invokeFactory("UrbanVocabularyTerm",id="330-3",title=u"330 3°",description="<p> « la construction, la reconstruction d’un magasin ou la modification de la destination d’un bâtiment en magasin dont la surface nette de vente est supérieure à 400 m2 ; la transformation de bâtiments ayant pour effet de placer ceux-ci dans les mêmes conditions »</p>")
    newFolder.invokeFactory("UrbanVocabularyTerm",id="330-4",title=u"330 4°",description="<p> « la construction, la reconstruction de bureaux ou la modification de la destination d’un bâtiment en bureaux dont la superficie des planchers est supérieure à 650 m2 ; la transformation de bâtiments ayant pour effet de placer ceux-ci dans les mêmes conditions »</p>")
    newFolder.invokeFactory("UrbanVocabularyTerm",id="330-5",title=u"330 5°",description="<p> « la construction, la reconstruction ou la modification de la destination d’un bâtiment en atelier, entrepôt ou hall de stockage à caractère non agricole dont la superficie des planchers est supérieure à 400 m2 ; la transformation de bâtiments ayant pour effet de placer ceux-ci dans les mêmes conditions »</p>")
