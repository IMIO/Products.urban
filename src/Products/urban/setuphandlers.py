...
def addUrbanConfigs(context):
    ...
    for urban_type in URBAN_TYPES:
        ...
        if urban_type in ['BuildLicence', 'ParcelOutLicence', ]:
            ...
            newFolder.invokeFactory("UrbanVocabularyTerm",id="bec",title=u"Bureau d'études communal")
            newFolder.invokeFactory("UrbanVocabularyTerm",id="svp",title=u"Service Voyer Principal")
            newFolder.invokeFactory("UrbanVocabularyTerm",id="agriculture",title=u"Agriculture")
            ...
            newFolder.invokeFactory("UrbanVocabularyTerm",id="cibe",title=u"CIBE/Vivaque")
            newFolder.invokeFactory("UrbanVocabularyTerm",id="sncb",title=u"SNCB")
            newFolder.invokeFactory("UrbanVocabularyTerm",id="infrabel",title=u"Infrabel")
            newFolder.invokeFactory("UrbanVocabularyTerm",id="voo",title=u"VOO")
